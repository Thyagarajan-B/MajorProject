...
const About = () => {
  return (
    <div>
      ...
      {/* Have to make changes in the UI in order to look different */}
      ...
      <div className='my-10 flex flex-col md:flex-row gap-12'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          ...
          <p>CareBridge is committed to excellence in healthcare technology. We continuously strive to enhance our platform, integrating the latest advancements to improve user experience and deliver superior service. Whether  booking your first appointment or managing ongoing care, CareBridge is here to support you every step of the way.</p>
